...
<div class="line"></div>
    ...
    <p>
        Wind whips through serene, empty streets around a mix of refurbished homes, stationary trailers and neglected abodes. Trash and discarded clothes cover some yards, while others are perfectly manicured.     </p>
    <p>
    ...
    <p>
        When 24-year-old Black geologist Daniel Robinson went mysteriously missing in Buckeye, Arizona, a so-called ‘sundown town’ near Phoenix, Black residents were forced to weigh Buckeye’s public statements with the painful lessons of history a few streets over.     </p>
    <p>
    ...
    <p>
        It was here, on this plot of land just off of South Palo Verde Road, that the community of Hopeville was established in the 1980s.    </p>
    <p>
    ...
    <p>
        Yet after barely four decades of treading water, Hopeville and its resilient residents now worry their town could be washed away yet again — not by flooding this time around, but by its own growth-crazed local officials.    </p>
    <div class="line"></div>
    <h3>
        The Before
    </h3>
    ...
    <p>
        The Allenville origin story opens with a scam. Back in 1944, Lee Norton, a local white realtor, sold a plot of land near Buckeye to Black people needing work and housing. Trouble was, the land sat smack in a floodplain, which meant anything built or cultivated on those plots could get washed away in a storm. But back then, prior to the passage of the <a href="https://www.estrellamountain.edu/news/2020/looking-back-allenville-buckeyes-all-black-community">1968 Fair Housing Act</a>, Black people were forbidden from living in Buckeye proper, according to local archives.    </p>
    <p>
    ...
    <p>
        Now and then, floodwaters would overflow and cause sewage and waste generated from then all-white Buckeye to spill over onto Allenville’s streets and become a breeding ground for mosquitoes. Such unsanitary conditions forced Allenville residents to source their water from Buckeye, which meant frequent trips to <a href="https://www.youtube.com/watch?v=4oEQ-0GFGoo">gas stations</a> to fill up jugs and collect their 5-gallon ration.    </p>
    <p>
        Despite tales of such hardship, longtime residents still boast about the  sense of community Allentown enjoyed back then - at least until 1978 when a couple of big floods nearly swept through town. Damage from the floods crippled the community, which had swelled with <a href="https://www.youtube.com/watch?v=4oEQ-0GFGoo">400</a> Black working class people, destroying homes and farms and forever changing Allenville’s landscape.
    </p>
    <p>
    ...
    <p>
        Yet again, <a href="https://www.azcentral.com/story/news/local/southwest-valley/2021/05/17/history-allenville-black-community-arizona-lost-floods/4993229001/">local policies</a> were not in residents’ favor: homes had to be rebuilt in accordance with particular county codes and regulations, and many of the economically disadvantaged Allenville residents could not afford to rebuild their homes up to code. Many residents applied for grants to reconstruct their homes in compliance with the regulations and were denied.     </p>
    <p>
        Eventually, the federal government sponsored a multimillion-dollar relocation project to move the remaining Allenville residents north of Buckeye, out of the path of the rivers’ wrath. The government enlisted the help of the <a href="https://www.azcentral.com/story/news/local/southwest-valley/2021/05/17/history-allenville-black-community-arizona-lost-floods/4993229001/">Army Corps of Engineers</a> to construct the community that would come to be known as Hopeville.    </p>
    <div class="line"></div>
    <h3>
...
<div class="photo">
    ...
    <p>Rhonda Douglass, who is married to Melvin, was alarmed when she received a letter from the city of Buckeye about the airport’s expansion. </p>
    <p>Douglass says that based on government notices, and her own digging, she has concluded that all of Hopeville is slated to become airport property, pushing Hopeville residents out of their homes in the next 20-30 years, she says.</p>
    <p>“We're gonna wait,” Rhonda Douglass says. “And … I'm 73 years old. He's 76. So we don't know where we’re gonna be in 20, 30 years.”</p>
    <p>According to the city’s <a href="https://www.buckeyeaz.gov/home/showpublisheddocument/6300/637157202046800000">Imagine Buckeye 2040 General Plan</a>, Buckeye plans to create “mixed use areas that provide live, work, and play destination locations” in the area. </p>
    <p>This so-called <a href="https://www.buckeyeaz.gov/community/buckeye-municipal-airport/airport-specific-area-plan-2023">Airport Area Plan</a> shows an activity center that covers the entire neighborhood of Hopeville.</p>
    <p> The area “will be used for policy guidance for the [city] staff and the development community to guide growth and identify future priorities for the activity center,” according to a fact sheet on the city’s website. “This will be accomplished by understanding existing
        conditions, planned infrastructure, and the vision for the area.”
        </p>
    <p>Buckeye spokesperson Annie DeChance originally said, in an email, that the goal of the Airport Area Plan is “to ensure Hopeville residents have minimal impacts as the airport grows with the city.” More recently, she says it is difficult to determine for certain what impacts the airport’s expansion will have on Hopeville residents.</p>
    <p> Meanwhile, Hopeville residents are left wondering what this means for them. Should a new, higher-rent development move into Hopeville, there are concerns current residents may not be able to afford to live in the area.</p>
    <p>“We are involving them in the process for each of these projects so they are fully knowledgeable about the potential future growth at the airport,” DeChance said in an email, adding that Hopeville residents could speak their mind at public hearings, city council workshops, planning and zoning workshops and community meetings. DeChance says Hopeville residents were informed about the airport’s expansion and the airport area plan in May 2022.</p>
    <p>Rhonda Douglass views the Airport Area Plan to level Hopeville in favor of a newer development as part of the area’s continuing legacy of prejudice against people of color – whether it's relocating them onto a flood plain or pushing them out to make way for developers.</p>
    <p>Douglass is angry and hurt that Buckeye would force another relocation – but parses her words in expressing it. “There are some good people, I mean, that’s anywhere,” she says, “And there is this obvious and blatant racism, that’s not just Buckeye.”</p>
</div>
</div>
<ReadNext />
