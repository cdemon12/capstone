...
{#if $open}
        ...
        <div class="article" in:slide out:slide>
            ...
            <p>Four in 1,000 Black Americans are reported missing every year, compared to one in 1,000 White Americans. And while most cases are resolved quickly, if a Black child is missing, it is more likely to be unresolved longer or remain unresolved altogether, according to <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6312271/">a 2018 study of missing children in New York</a>. This is most likely because searches for Black missing person cases often have less support, on top of the already limited resources for missing person cases.</p>
            <p>Daniel’s father, David Robinson, has been searching for his son for nearly two years to no avail. At the beginning of his search, for his initial meeting with Buckeye police, David Robinson asked Larnell Farmer of the West Valley NAACP in Arizona to join him.</p>
            <p>“The lack of sympathy, empathy, respect that they gave David on that day, it was horrible,” Farmer said. In this meeting, Farmer said the police proposed a story that involved Daniel Robinson disappearing under his own fruition. This is quite common in Black missing person cases.</p>
            <p>When police reports are filed for missing children of color, it’s usually assumed that they’re runaways, said Derrica Wilson, who co-founded the <a href="https://www.blackandmissinginc.com/">Black and Missing Foundation</a>. When adults of color go missing, they’re labeled as criminals. This stereotyping has a dehumanizing and desensitizing effect, she said.</p>
            <p>This placing of blame on the missing individual affects how the police act in the vital, first days someone is missing. For instance, if a child is labeled as a runaway, <a href="https://scholarship.law.wm.edu/wmjowl/vol25/iss3/9/">the police can’t issue an AMBER alert, one of the most successful tools in abduction cases.</a></p>
            <p>This common disregard is also relayed into media coverage, another important tool in locating missing persons. Nine percent of media missing children mentions involve Black children, despite making up 36% of cases, according to <a href="https://www.tandfonline.com/doi/abs/10.1080/08824096.2015.1052898">a 2015 study of media coverage of missing children</a>. “When a person of color goes missing, it’s barely reported in the local news,” said Bishop Anthony Holt, president of the NAACP chapter local to where Daniel Robinson went missing. “So the question is, is one life better than another? Or is one life more valuable than another?”</p>
...
<style lang="sass">
    ...
    .article
        ...
        z-index: 99998
        top: 90px
        left: calc((100% - min(calc(100% - 80px), 1120px) - 80px) / 2)
